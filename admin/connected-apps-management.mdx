...
- A Slack app your organization registered itself appears here as its own app, **Slack (bot name)**, listing only that bot's tools — with the same per-tool controls as any other app.
