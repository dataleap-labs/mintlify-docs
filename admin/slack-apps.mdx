...
To change scopes later, click **Edit scopes** on the card, adjust them, and click **Update scopes**. **Granted scopes** lists what Slack actually granted, split into **Bot scopes** and **User scopes**.
