...
<Frame caption="The model selector — Expert, Pro, or Basic. Customize picks a specific model.">
  <img src="/images/admin-models-member-selector.png" alt="The model selector in the chat bar showing Basic, Pro, Expert, and Customize" />
</Frame>
