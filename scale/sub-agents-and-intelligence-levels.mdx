...
<Frame caption="The model selector — Expert, Pro, or Basic. Customize picks a specific model.">
  <img src="/images/intelligence-selector-chat.png" alt="The model selector in the chat bar with Expert, Pro, and Basic options" />
</Frame>
...
<Frame caption="Main agent: model selector in the Workflow tab.">
  <img src="/images/intelligence-selector-workflow.png" alt="An agent's Workflow tab showing its triggers and the model selector set to Pro" />
</Frame>

<Frame caption="Sub-agent: its own model selector in the Tools tab.">
  <img src="/images/intelligence-selector-subagent.png" alt="The Candidate Scorer sub-agent with its own model selector set to Pro" />
</Frame>
