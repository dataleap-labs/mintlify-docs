...
The external tools your agents can access. Connect once — Dataleap asks for what it needs while you build, or manage everything under **Settings** > **Connected Apps** — and agents reuse the connection. See [Connect, use, and disconnect apps](/build/connect-your-tools) for the full connection lifecycle.
