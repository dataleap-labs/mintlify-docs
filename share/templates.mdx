...
{/* TODO(simon): Screenshot needed — Share dialog, Template tab. The previous image (/images/template-share-popover.png) showed the Share popover as it looked before Use only shipped. */}
